...
@section('content')
    <div class="starter-template">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <textarea id="sqlBlockId" name="sqlcode" class="form-control" rows="3">{{ isset($sqlcode) && !empty($sqlcode) ? $sqlcode : "CREATE TABLE `news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;"}}</textarea>
            </div>
